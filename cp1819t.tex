...
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}\Varid{f}\;(\Conid{Op}\;\text{\ttfamily \char34 *\char34})\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{a}\plus \Varid{b}\plus [\mskip1.5mu \text{\ttfamily \char34 MULT\char34}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[24]{}\Varid{anaFS}\mathbin{\$}\Varid{f}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{f}{}\<[12]%
\>[12]{}\mathrel{=}\Varid{cond}\;\Varid{maior}\;(\uncurry{\cdot }\mathbin{\$}\Varid{goForward})\;(\Varid{cond}\;\Varid{igual}\;(\uncurry{\cdot }\mathbin{\$}\Varid{newFile})\;(\uncurry{\cdot }\mathbin{\$}\Varid{notHere})){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{goForward}\;(\Varid{a},\Varid{b})\;(\Conid{FS}\;\Varid{l})\mathrel{=}\map \;(\Varid{progresso}\;(\Varid{a},\Varid{b}))\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{progresso}\;(\Varid{a},\Varid{b})\;(\Varid{i},\Conid{File}\;\Varid{f})\mathrel{=}(\Varid{i},i_1\;\Varid{f}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{progresso}\;(\Varid{a},\Varid{b})\;(\Varid{i},\Conid{Dir}\;\Varid{d})\mathrel{=}\mathbf{if}\;(\Varid{head}\;\Varid{a}\equiv \Varid{i})\;\mathbf{then}\;(\Varid{i},i_2\;((\Varid{tail}\;\Varid{a},\Varid{b}),\Varid{d}))\;\mathbf{else}\;(\Varid{i},i_2\;(([\mskip1.5mu \mskip1.5mu],\Varid{b}),\Varid{d})){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{newFile}\;(\Varid{a},\Varid{b})\;(\Conid{FS}\;\Varid{l})\mathrel{=}(\Varid{curry}\;\mathsf{conc})\;[\mskip1.5mu (\Varid{head}\;\Varid{a},i_1\;\Varid{b})\mskip1.5mu]\mathbin{\$}\map \;(\Varid{endOfPath}\;(\Varid{a},\Varid{b}))\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{notHere}\;(\Varid{a},\Varid{b})\;(\Conid{FS}\;\Varid{l})\mathrel{=}\map \;(\Varid{endOfPath}\;(\Varid{a},\Varid{b}))\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{endOfPath}\;(\Varid{a},\Varid{b})\;(\Varid{i},\Conid{File}\;\Varid{f})\mathrel{=}(\Varid{i},i_1\;\Varid{f}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{endOfPath}\;(\Varid{a},\Varid{b})\;(\Varid{i},\Conid{Dir}\;\Varid{d})\mathrel{=}(\Varid{i},i_2\;(([\mskip1.5mu \mskip1.5mu],\Varid{b}),\Varid{d})){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{maior}\mathrel{=}(\mathbin{>}\mathrm{1})\comp \length \comp \p1\comp \p1{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{igual}\mathrel{=}(\equiv \mathrm{1})\comp \length \comp \p1\comp \p1{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{cp}\mathrel{=}{}\<[7]%
\>[7]{}\Varid{curry}\comp \Varid{curry}\mathbin{\$}\Varid{f}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\mathbf{where}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{f}\;((\Varid{a},\Varid{b}),\Varid{fs})\mathrel{=}\Varid{copiaFich}\;\Varid{a}\;\Varid{fs}\;(\Varid{conteudo}\;(\Varid{a},\Varid{fs})){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{copiaFich}\;\Varid{a}\;\Varid{fs}\;(\Conid{FS}\;\Varid{l})\mathrel{=}\mathbf{if}\;\length \;\Varid{l}\mathbin{>}\mathrm{0}\;\mathbf{then}\;\Varid{new}\;\Varid{a}\;((\lambda (\Conid{File}\;\Varid{b})\to \Varid{b})\comp \p2\mathbin{\$}\Varid{head}\;\Varid{l})\;\Varid{fs}\;\mathbf{else}\;\Varid{fs}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{conteudo}\mathrel{=}\Varid{anaFS}\;\Varid{g}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{g}\mathrel{=}\Varid{cond}\;((\geq \mathrm{1})\comp \length \comp \p1)\;(\uncurry{\cdot }\mathbin{\$}\Varid{followPath})\;\Varid{nil}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{followPath}\;\Varid{a}\;(\Conid{FS}\;\Varid{l})\mathrel{=}\map \;(\Varid{transf}\;\Varid{a})\mathbin{\$}\Varid{filter}\;(\Varid{path}\;\Varid{a})\;\Varid{l}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{path}\;\Varid{p}\;(\Varid{a},\Varid{x})\mathrel{=}\Varid{head}\;\Varid{p}\equiv \Varid{a}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{transf}\;\Varid{p}\;(\Varid{a},\Conid{File}\;\Varid{b})\mathrel{=}(\Varid{a},i_1\;\Varid{b}){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{transf}\;\Varid{p}\;(\Varid{a},\Conid{Dir}\;\Varid{fs})\mathrel{=}(\Varid{a},i_2\;(\Varid{tail}\;\Varid{p},\Varid{fs})){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{cFS2Exp}\mathrel{=}\Varid{curry}\mathbin{\$}\Varid{anaExp}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{g}\;(\Varid{a},\Conid{FS}\;\Varid{l})\mathrel{=}i_2\;(\Varid{a},\map \;(\Varid{leitura})\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{leitura}\;(\Varid{a},\Conid{File}\;\Varid{b})\mathrel{=}(\Varid{a},\Conid{FS}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{leitura}\;(\Varid{a},\Conid{Dir}\;\Varid{fs})\mathrel{=}(\Varid{a},\Varid{fs}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
