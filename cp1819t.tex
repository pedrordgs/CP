...
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{g}\;(\Conid{H})\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x}\mathbin{+}\Varid{a},\Varid{max}\;\Varid{y}\;\Varid{b}){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{g}\;(\Conid{Hb})\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x}\mathbin{+}\Varid{a},\Varid{max}\;\Varid{y}\;\Varid{b}){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{g}\;(\Conid{Ht})\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x}\mathbin{+}\Varid{a},\Varid{max}\;\Varid{y}\;\Varid{b}){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\Varid{g}\;\Varid{t}\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{max}\;\Varid{x}\;\Varid{a},\Varid{y}\mathbin{+}\Varid{b}){}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
...
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{f}\mathbin{::}((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}),\Conid{Origem})\to (\Conid{Caixa},\Conid{Origem})+((),(((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}),\Conid{Origem}),((\Conid{X}\;\Conid{Caixa}\;\Conid{Tipo}),\Conid{Origem}))){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{f}\;(\Conid{Unid}\;\Varid{a},\Varid{c})\mathrel{=}i_1\;(\Varid{a},\Varid{c}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{f}\;(\Conid{Comp}\;\Varid{t}\;\Varid{a}\;\Varid{b},\Varid{c})\mathrel{=}i_2\;((),((\Varid{a},\Varid{c}),(\Varid{b},\Varid{calc}\;\Varid{t}\;\Varid{c}\;(\Varid{h}\;\Varid{t}\;\Varid{a}\;\Varid{b})))){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{g}\;\Conid{H}\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x},\Varid{y}\mathbin{/}\mathrm{2}\mathbin{-}\Varid{b}\mathbin{/}\mathrm{2}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{g}\;\Conid{Ht}\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x},\Varid{y}\mathbin{-}\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{g}\;\Conid{Hb}\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x},\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{g}\;\Conid{V}\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x}\mathbin{/}\mathrm{2}\mathbin{-}\Varid{a}\mathbin{/}\mathrm{2},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{g}\;\Conid{Vd}\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x}\mathbin{-}\Varid{a},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{g}\;\Conid{Ve}\;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\mathrm{0},\Varid{y}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{h}\;\Varid{t}\;\Varid{a}\;\Varid{b}\mathrel{=}\Varid{g}\;\Varid{t}\;(\Varid{dimen}\;\Varid{a})\;(\Varid{dimen}\;\Varid{b}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calc}\mathbin{::}\Conid{Tipo}\to \Conid{Origem}\to (\Conid{Float},\Conid{Float})\to \Conid{Origem}{}\<[E]%
\\
\>[B]{}\Varid{calc}\;\anonymous \;(\Varid{x},\Varid{y})\;(\Varid{a},\Varid{b})\mathrel{=}(\Varid{x}\mathbin{+}\Varid{a},\Varid{y}\mathbin{+}\Varid{b}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment calc :: Tipo -> Origem -> (Float, Float) -> Origem}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment calc H (x,y) (a,b) =}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment calc Hb (x,y) (a,b) =}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment calc Ht (x,y) (a,b) =}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment calc V (x,y) (a,b) =}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment calc Vd (x,y) (a,b) =}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment calc Ve (x,y) (a,b) =}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{agrup\char95 caixas}\mathbin{::}\Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;()\to \Conid{Fig}{}\<[E]%
\\
